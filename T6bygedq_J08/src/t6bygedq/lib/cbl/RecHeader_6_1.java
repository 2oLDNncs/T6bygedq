 ...
 */
public final class RecHeader_6_1 extends RecHeader {
	
	public final EnumVar<RecordType_6_1> vRecordType = this.newEnumVar(RECORD_TYPE, RecordType_6_1.decoder);
	...
	public final <R extends RecData> void setRecordTypeFromDataClass(final Class<R> cls) {
		this.vRecordType.set(RecHeader_6_1.RecordType_6_1.fromRecDataClass(cls));
	}
	
	/**
	 * @author 2oLDNncs 20250204
	 */
	public static enum RecordType_6_1 implements RecordType {
		...
		OPTIONS                   (RecData_X0010_Options_6_1.class),
		...
		SYMBOL                    (RecData_X0042_Symbol_6_1.class),
		...
		private RecordType_6_1(final Class<? extends RecData> recDataClass) {
		...
		static final Decoder<Integer, RecordType_6_1> decoder =
				new ReversibleMap<Integer, RecordType_6_1>()
		...
		private static final Map<Class<? extends RecData>, RecordType_6_1> fromClass = new HashMap<>();
		
		static {
			for (final RecordType_6_1 rt : values()) {
				fromClass.put(rt.recDataClass, rt);
			}
		}
		
		public static final RecordType_6_1 fromRecDataClass(final Class<? extends RecData> cls) {
