 ...
 */
public final class RecData_X0042_Symbol_6_1 extends RecData_X0042_Symbol {
...
//	public final StringVar                          vInitialValueData          = this.newStringVarV(INITIAL_VALUE_LENGTH);
	...
	public RecData_X0042_Symbol_6_1(final Buffer buffer) {
		super(buffer);
	}
	...
	public final class Pair extends RecPart {
		...
		Pair(final Buffer.Region.Generator rg) {
			super(RecData_X0042_Symbol_6_1.this.buffer);
			Buffer.DEBUG = false;
	...
	private static final Buffer.Region.Generator staticRegionGenerator =
			getStaticRegionGenerator(RecData_X0042_Symbol_6_1.class);
	...
	static {
		Helpers.ignore(DATE_FORMAT); // Actually defined in 4.2
