...
public final class MakeTextTemplate {
	...
	public static final void main(final String... args) throws IOException {
		...
		{
			var name = removeExt(ap.getFile(ARG_IN).getName());
		...
		final var superTemplateClass = TextTemplate.class;
		final var textTemplatePrinterClass = TextTemplatePrinter.class;
		final var textTemplatePrinterClassName = textTemplatePrinterClass.getSimpleName();
